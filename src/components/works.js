      ...
      <React.Fragment>
        <section id="works">
          ...
          <article>
            <div className="card">
              <picture>
                <source srcSet="/githubpages1st.webp" type="image/webp" />
                <img src="/githubpages1st.jpg" alt="screen-shot from 1st Githubpages" />
              </picture>
            ...
            <div className="card">
              <picture>
                <source srcSet="/codr.webp" type="image/webp" />
                <img src="/codr.jpg" alt="screen-shot from this webpage" />
              </picture>
              <h3>Coder0</h3>
