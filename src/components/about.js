  ...
  return (
    <React.Fragment>
      <section id="about">
        ...
        <p>My mayjor was especially botanics. And in agricultural production system engineering lablatory, I studied crop row detecting technique by image processing with C++ and OpenCV.</p>
        <br />
        <p>After the graduation, I worked at Egg company but quited this and stayed at Australia as working holiday. Then I had a good chance to study Ruby and other tech like database, website system.</p>
        <br />
